...
public class EI_BezeroaGehituta extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EI_BezeroaGehituta frame = new EI_BezeroaGehituta(nan, izena, jaiotzeData, helbidea);
	 ...
	 * Create the frame.
	 */
	public EI_BezeroaGehituta(String nan, String izena, String jaiotzeData, String helbidea) {
		setTitle("Ondo!");
